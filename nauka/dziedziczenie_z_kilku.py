...
class PromoCake(Cake, Promo):
    """jezeli tutaj cos wpisze to taka dokumentacja będzie wyświetlana przy pomocy help(nazwa klasy, nazwa metody, czy instacja)"""
    def __init__(self, cake, promo):# jesli masz dwoje rodziców to nie musisz wymieniac wszystkich atrybutów tylko nazwe instancji dla kazdej klasy tylko nazwe ktorej bedziesz używał poniżej wymieniając poszczególne argumenty po "."
